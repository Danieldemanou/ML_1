...
### Activation function (you can choose sigmoid or ReLU)
act_func_name = "sigmoid"
## this is the architecture of the hidden layers 
architecture_hidden_layer = [128,128]
### Network Architecture
nn_arch = np.array([n_feature] + architecture_hidden_layer + [n_label])
...
#for i in range(200):
    ...
    valid_val.append(valid_accuracy)
...
plt.plot(iteration,train_val,'r--',iteration,train_val,'bs')

plt.title("evolution of train_accuracy and valid_accuracy")
plt.xlabel("iteration", fontsize=14)
plt.ylabel("accuracy", fontsize=14)
plt.savefig('evolution of train_accuracy and valid_accuracy.png')
plt.show()